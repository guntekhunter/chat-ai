  ...
  return (
    <div className="w-full h-[100vh] relative bg-[#EFEAE2] md:text-[1rem] text-[.8rem]">
      <div className="md:px-[3rem] px-[1rem] py-[.5rem] shadow-md bg-[#F0F2F5] flex space-x-3 sticky top-0">
        ...
        <div>
          <p className="mt-[.2rem] font-bold">So'na</p>
          <p
            className={`${
              isLoading ? "" : "hidden"
      ...
      <div
        className={`flex flex-col-reverse w-full md:px-[3rem] px-[1rem] pt-[1rem] md:pb-[6rem] pb-[4rem] bg-[#EFEAE2] overflow-hidden h-[85vh] overflow-y-scroll scrollbar-thin scrollbar-track-[#FFFFFF] scrollbar-thumb-[#9BCDD2]`}
      >
